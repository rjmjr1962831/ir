...
.form-group label{font-size:.9rem;font-weight:600;color:#c8a951;text-transform:uppercase;letter-spacing:0.5px}
.req{color:#d62828}
...
.form-group input:focus,.form-group textarea:focus{outline:none;border-color:#c8a951}
...
.support-note a{color:#c8a951;font-weight:600}
</style>`;
